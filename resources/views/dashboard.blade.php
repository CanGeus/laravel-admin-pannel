            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/listuser">List Usres</a>
                    </div>
                </div>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <script>
                            ...
                            setInterval(() => {
                                lineData = Math.floor(Math.random() * 20) + 50;
                                
                                // Update chart data
                                data.datasets[0].data.push(lineData);
                            ...
                            type: 'bar',
                            data: {
                                labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July','Agusts', 'September', 'October', 'Novenber'],
                                datasets: [{
                                    label: 'Employee Attendance',
                                    data: [12, 19, 3, 5, 2, 3, 7,3,5,6,10], 
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <!-- Card Body -->
                                <div class="card-body">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.529794198858!2d110.41395247605381!3d-7.064399769237042!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e70894c3b713051%3A0x1bee99b12cd19f4c!2sCrocodic%20-%20Mobile%20Apps%20Developer%20Indonesia%20-%20Jasa%20Pembuatan%20Aplikasi%20Android%20iOS!5e0!3m2!1sen!2sid!4v1721457872801!5m2!1sen!2sid" width="100%" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                                </div>
                            </div>
                        </div>
